...
class GraphRAGConfig:
    ...
    def from_env(cls) -> "GraphRAGConfig":
        ...
        return cls(
            ...
            timeout_seconds=_get_env("RAG_TIMEOUT_SECONDS", int, aliases=("RAG_TIMEOUT",)) if os.getenv("RAG_TIMEOUT_SECONDS") or os.getenv("RAG_TIMEOUT") else 45,
            bootstrap_timeout_seconds=_get_env("RAG_BOOTSTRAP_TIMEOUT_SECONDS", int, aliases=("RAG_INIT_TIMEOUT_SECONDS",)) if os.getenv("RAG_BOOTSTRAP_TIMEOUT_SECONDS") or os.getenv("RAG_INIT_TIMEOUT_SECONDS") else 180,
        )
